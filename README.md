...
| [MCP Toolbox](https://github.com/googleapis/mcp-toolbox) (16.1k★) | [#3520](https://github.com/googleapis/mcp-toolbox/pull/3520) | SSE handler rendered a 500 when the writer was no http.Flusher but fell through, leaving a nil flusher that panicked on the first Flush; return right after the error render |
...
| [MCP Toolbox](https://github.com/googleapis/mcp-toolbox) (16.1k★) | [#3520](https://github.com/googleapis/mcp-toolbox/pull/3520) | SSE handler 遇到不支持 http.Flusher 的 writer 时渲染 500 却没 return，nil flusher 在第一次 Flush 直接 panic；现在渲染完就返回 |
