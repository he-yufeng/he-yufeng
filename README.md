...
- 200+ merged upstream PRs, with fixes in vLLM (9 merged), Mooncake (20 merged), Qwen Code (49 merged), Microsoft Agent Framework (20 merged), AstrBot (30 merged), Google ADK (10 merged), Inspect AI (16 merged), Hugging Face Transformers (1 merged), and PyTorch (3 merged).
...
- 200+ 个上游 PR 已 merged，其中 vLLM（9 个）、Mooncake（20 个）、Qwen Code（49 个）、Microsoft Agent Framework（20 个）、AstrBot（30 个）、Google ADK（10 个）、Inspect AI（16 个）、Hugging Face Transformers（1 个）、PyTorch（3 个）。
