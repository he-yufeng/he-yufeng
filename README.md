...
- 200+ merged upstream PRs, with fixes in vLLM (9 merged), Mooncake (12 merged), Qwen Code (39 merged), Microsoft Agent Framework (19 merged), AstrBot (30 merged), Inspect AI (10 merged), Hugging Face Transformers (1 merged), and PyTorch (3 merged).
