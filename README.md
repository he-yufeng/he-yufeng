...
- 20 public projects, led by CoreCoder, Agent ToolFence, IssueBenchKit, RepoWiki, FindJobs-Agent, ContractGuard, AgentProbe, GitSense, and MTSIR3-GAN.
...
- 20 个公开项目，代表项目包括 CoreCoder、Agent ToolFence、IssueBenchKit、RepoWiki、FindJobs-Agent、ContractGuard、AgentProbe、GitSense、MTSIR3-GAN。
